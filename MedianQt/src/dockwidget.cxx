...
DockWidget::DockWidget(QComboBox *combo,QWidget *parent)
    :QDockWidget(parent),myCombo(combo)
{
...
QVBoxLayout * DockWidget::createDockWidgetLayout(QString text)
{
    QVBoxLayout *layout = new QVBoxLayout();
    ...
    myTreeWidget->setHeaderLabel("File Attributes");
    layout->addWidget(myTreeWidget);
...
void DockWidget::slotChangeDockWidget(QString text)
{
    QWidget *widget = new QWidget();
